...
The integrals in the analytical computation of EIL and UIL are calculated using the "_integrate_" R function, based on QUADPACK routines dqags and dqagi by R. Piessens et al. \cite{PIE}. The code shown is simplified for displaying purposes. Checkout the Github repository for the full version.
