...
\label{itimint}
 ...
 The two-dimensional integrals for the computation of "_time in-the-money_" (TITM) are calculated using the dblquad function from the pracma library [ref]. 
