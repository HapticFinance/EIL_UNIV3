...
mat_eil_mu_one <- run_calc(168) 

mat_eil_mu_one_long <- run_calc(720) 
...
collapse_rows_dt <- data.frame(
    C1 = mat_eil_mu_one[1:nrow(mat_eil_mu_one), 1],
    C2 = mat_eil_mu_one[1:nrow(mat_eil_mu_one), 2],
    C3 = mat_eil_mu_one[1:nrow(mat_eil_mu_one), 3],
    C4 = mat_eil_mu_one[1:nrow(mat_eil_mu_one), 4],
    C5 = mat_eil_mu_one[1:nrow(mat_eil_mu_one), 5],
    C6 = mat_eil_mu_one[1:nrow(mat_eil_mu_one), 6],
    C7 = mat_eil_mu_one[1:nrow(mat_eil_mu_one), 7],
    C8 = mat_eil_mu_one[1:nrow(mat_eil_mu_one), 8],
    C9 = mat_eil_mu_one[1:nrow(mat_eil_mu_one), 9],
    C10 = mat_eil_mu_one[1:nrow(mat_eil_mu_one), 10]
)
...
collapse_rows_dt <- data.frame(
    C1 = mat_eil_mu_one_long[1:nrow(mat_eil_mu_one_long), 1],
    C2 = mat_eil_mu_one_long[1:nrow(mat_eil_mu_one_long), 2],
    C3 = mat_eil_mu_one_long[1:nrow(mat_eil_mu_one_long), 3],
    C4 = mat_eil_mu_one_long[1:nrow(mat_eil_mu_one_long), 4],
    C5 = mat_eil_mu_one_long[1:nrow(mat_eil_mu_one_long), 5],
    C6 = mat_eil_mu_one_long[1:nrow(mat_eil_mu_one_long), 6],
    C7 = mat_eil_mu_one_long[1:nrow(mat_eil_mu_one_long), 7],
    C8 = mat_eil_mu_one_long[1:nrow(mat_eil_mu_one_long), 8],
    C9 = mat_eil_mu_one_long[1:nrow(mat_eil_mu_one_long), 9],
    C10 = mat_eil_mu_one_long[1:nrow(mat_eil_mu_one_long), 10]
)
